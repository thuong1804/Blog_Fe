                                        ...
                                        {itemCardByWithCategory && (
                                            <div className="bg-[#f6f8fa] p-9 rounded-r-2xl hidden lg:block" onClick={() => onClickLink?.()}>
                                                <ItemCardPost
                                                    ...
                                                    image={
                                                        itemCardByWithCategory.image
                                                    }
                                                    description={
                                                        itemCardByWithCategory.description
                                                    }
                                                    slug={
                                                        itemCardByWithCategory.slug
                                                    }
                                                    createdAt={
                                                        itemCardByWithCategory.createdAt
                                                    }
                                                    author={
                                                        itemCardByWithCategory.author
                                                    }
                                                    category={
                                                        itemCardByWithCategory.category
                                                    }
                                                    imageSize="md"
                                                />
                                            </div>
