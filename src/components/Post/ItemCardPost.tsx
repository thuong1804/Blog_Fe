...
const ItemCardPost: React.FC<ItemCardBlogProps & ItemCardPostProps> = ({
    ...
    return (
        <div
            className={` max-w-[400px] max-h-[700px] flex flex-col ${imageSize} border-b-1 border-gray-300 pb-10 relative`}
        >
            {isLogin && (
            ...
            >
                <div
                    className={`relative overflow-hidden rounded-2xl cursor-pointer ${imageClass} flex justify-center`}
                >
                    <Image
                        src={image}
                        fill
                ...
                <h4 className="group-hover:underline group-hover:text-(--text-color-primary) text-2xl font-bold text-black mt-4">
                    {title}
                </h4>
                <div className="text-[#999999] text-[16px] font-normal mt-2 truncate w-full">
                    {description}
                </div>
            ...
            <Link
                ...
                className="text-[#7C4EE4] text-lg font-bold underline mt-5"
            >
                Read more...
            </Link>
        </div>
