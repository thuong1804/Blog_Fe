  ...
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div className=" bg-white rounded-box shadow-2xs p-14 flex flex-col items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="opacity-90 max-w-[450px] w-[450px] mt-10">
          ...
          <div className="flex items-center justify-end w-full mt-8">
            <Button loading={loading} type="submit" classNames="w-max rounded-[10px]" title="Send email" disabled={loading}/>
          </div>
        </form>
      </div>
    </div>
