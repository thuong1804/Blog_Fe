        ...
        <div>
            <div className="relative w-full h-[600px] mt-20">
                ...
                <form
                    ...
                    className="absolute bottom-[-80%] left-1/2 -translate-x-1/2 bg-white rounded-box shadow-lg max-w-[700px] w-[700px] p-14 flex flex-col gap-10"
                >
                    <div className="grid grid-cols-2 gap-5">
                        ...
                        <fieldset className="fieldset relative">
                            ...
                            <div className="validator-hint hidden absolute bottom-[-20px]">
                    ...
                    <div className="w-full h-[200px]">
                        <fieldset className="fieldset w-full h-full">
                            ...
                            <textarea
                                ...
                                name="message"
                                onChange={handleChange}
                                className=" h-[150px] textarea w-full text-black bg-white border-1 border-gray-400"
                            ></textarea>
                        </fieldset>
                    </div>
            ...
            <div className="bg-white h-[750px] w-full"></div>
        </div>
    );
};
