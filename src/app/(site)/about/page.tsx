        ...
        <div className="w-full pb-20 pt-14 px-5">
            <div className="max-w-(--max-width-desktop) mx-auto">
                <div className=" flex flex-col items-center">
                    ...
                    <h1 className="max-w-[650px] text-center leading-18 mt-4">
                        Creative Blog Writting and publishing site
                    </h1>
                    <p className="max-w-[1000px] text-center leading-6 mt-4">
                ...
                <div className="flex items-end justify-between  mt-5 ">
                    <h1 className="max-w-[500px] text-left m-0 p-0 leading-16">
